...
let weapon = new Bitmap('../../assets/knife_hand.png', 319, 320);
let sky = new Bitmap('../../assets/deathvalley_panorama.jpg', 2000, 750);
let wallImg = new Bitmap('../../assets/wall_texture.jpg', 1024, 1024);
